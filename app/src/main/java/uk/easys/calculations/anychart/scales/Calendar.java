...
public class Calendar extends Base {
     ...
     */
    public uk.easys.calculations.anychart.scales.Calendar availabilities(uk.easys.calculations.anychart.scales.calendar.Availability[] availabilities) {
     ...
     */
    public void getWorkingSchedule(Number startDate, Number endDate, uk.easys.calculations.anychart.enums.Interval unit, Number count) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Calendar timezoneOffset(Number var_offset) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Calendar weekendRange(Number[] var_range) {
