package uk.easys.calculations.anychart;
...
import static uk.easys.calculations.Home.whichChart;
...
public final class AnyChartView extends FrameLayout {
    ...
    private void init() {
        int lay = R.layout.view_anychart_1;
        int id = R.id.view_anychart_1;//R.id.web_view
        switch (whichChart) {
            case 1:
                lay = R.layout.view_anychart_2;
                id = R.id.view_anychart_2;
                break;
            case 2:
                lay = R.layout.view_anychart_3;
                id = R.id.view_anychart_3;
                break;
        }
        whichChart += 1;
        if (whichChart == 3) whichChart = 0;

        LayoutInflater inflater = (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(lay, this, true);
