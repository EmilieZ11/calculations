...
public class ContextMenu extends JsObject {
     ...
     */
    public uk.easys.calculations.anychart.ui.ContextMenu attach(uk.easys.calculations.anychart.core.Chart target, Boolean capture) {
     ...
     */
    public uk.easys.calculations.anychart.ui.ContextMenu enabled(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.ui.ContextMenu items(uk.easys.calculations.anychart.ui.contextmenu.Item[] itemsList) {
...
<b>Note</b>: Items provider called before items formatter.
     ...
     */
    public uk.easys.calculations.anychart.ui.ContextMenu setup(String var_args) {
     ...
     * Setups the element using passed configuration value.
     */
    public uk.easys.calculations.anychart.ui.ContextMenu setup(Number var_args) {
     ...
     * Setups the element using passed configuration value.
     */
    public uk.easys.calculations.anychart.ui.ContextMenu setup(Boolean var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".setup(%s);", var_args));
