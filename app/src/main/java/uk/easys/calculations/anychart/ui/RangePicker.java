...
Removes it from parent layer, nulls links, removes from DOM.
     ...
     */
    public uk.easys.calculations.anychart.ui.RangePicker fromLabelText(String text) {
     ...
     */
    public uk.easys.calculations.anychart.ui.RangePicker toLabelText(String text) {
