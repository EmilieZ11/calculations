...
public class DateTimeTicks extends Base {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeTicks count(Number count) {
...
<b>Note:</b> Interval value can get only if it was set explicitly, otherwise, it returns NaN.
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeTicks interval(String isoDate) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeTicks interval(uk.easys.calculations.anychart.enums.Interval unit, Number count) {
     ...
     * Setter for ticks interval value by the unit.
     */
    public uk.easys.calculations.anychart.scales.DateTimeTicks interval(String unit, Number count) {
...
<b>Note:</b> If any passed value is defined but is not a number or less than 0, it defaults to NaN and count() resets to 5.
     */
    public uk.easys.calculations.anychart.scales.DateTimeTicks interval(Number years, Number months, Number days, Number hours, Number minutes, Number seconds) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeTicks set(String[] ticks) {
