...
public class LinearColor extends ScatterBase {
     ...
     */
    public uk.easys.calculations.anychart.scales.LinearColor colors(String var_args) {
     ...
     * Setter for the linear gradient for the linear color scale.
     */
    public uk.easys.calculations.anychart.scales.LinearColor colors(uk.easys.calculations.anychart.graphics.vector.SolidFill var_args) {
     ...
     * Setter for the linear gradient for the linear color scale.
     */
    public uk.easys.calculations.anychart.scales.LinearColor colors(uk.easys.calculations.anychart.graphics.vector.LinearGradientFill var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colors(%s);", (var_args != null) ? var_args.getJsBase() : null));
     ...
     * Setter for the linear gradient for the linear color scale.
     */
    public uk.easys.calculations.anychart.scales.LinearColor colors(uk.easys.calculations.anychart.graphics.vector.RadialGradientFill var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".colors(%s);", (var_args != null) ? var_args.getJsBase() : null));
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public uk.easys.calculations.anychart.scales.LinearColor extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public uk.easys.calculations.anychart.scales.LinearColor inverted(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.LinearColor maximum(Number maximum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.LinearColor minimum(Number minimum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.LinearColor minorTicks(String ticks) {
...
call of this method if needed.
     */
    public uk.easys.calculations.anychart.scales.LinearColor startAutoCalc() {
     ...
     */
    public uk.easys.calculations.anychart.scales.LinearColor ticks(String ticks) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     */
    public uk.easys.calculations.anychart.scales.LinearColor alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public uk.easys.calculations.anychart.scales.LinearColor alignMinimum(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.LinearColor maxTicksCount(Number count) {
