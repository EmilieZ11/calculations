...
public class GanttDateTime extends Base {
     ...
     */
    public uk.easys.calculations.anychart.scales.GanttDateTime maximum(Number maximum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GanttDateTime maximumGap(Number gap) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GanttDateTime minimum(Number minimum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GanttDateTime minimumGap(Number gap) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GanttDateTime softMaximum(Number maximum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GanttDateTime softMinimum(Number minimum) {
