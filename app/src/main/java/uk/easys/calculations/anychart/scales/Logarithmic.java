package uk.easys.calculations.anychart.scales;
...
import uk.easys.calculations.anychart.scales.Linear;
...
public class Logarithmic extends Linear {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic alignMinimum(Boolean enabled) {
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic inverted(Boolean enabled) {
...
<b>Note:</b> Affects tick values auto calculation.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic logBase(Number baseValue) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic maximum(Number maximum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic maximumGap(Number gap) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic minimum(Number minimum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic minimumGap(Number gap) {
     ...
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks minorTicks() {
        return new uk.easys.calculations.anychart.scales.ScatterTicks(jsBase + ".minorTicks()");
    }
    /**
     * Setter for set of scale minor ticks in terms of data values.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic minorTicks(String settings) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic softMaximum(Number maximum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic softMinimum(Number minimum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic stackDirection(uk.easys.calculations.anychart.enums.ScaleStackDirection direction) {
     ...
     * Setter for the stacking direction.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic stackDirection(String direction) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic stackMode(uk.easys.calculations.anychart.enums.ScaleStackMode value) {
     ...
     * Setter for the stacked mode.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic stackMode(String value) {
...
call of this method if needed.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic startAutoCalc() {
...
Flag to stick to zero value on auto calc if gaps lead to zero crossing.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic stickToZero(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks ticks() {
        return new uk.easys.calculations.anychart.scales.ScatterTicks(jsBase + ".ticks()");
    }
    /**
     * Setter for set of scale ticks in terms of data values.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic ticks(String settings) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic compareWith(uk.easys.calculations.anychart.enums.ScaleCompareWithMode mode) {
     ...
     * Setter for the date which should be used as a changes zero for series.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic compareWith(String mode) {
     ...
     * Setter for the date which should be used as a changes zero for series.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic compareWith(Number mode) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic comparisonMode(uk.easys.calculations.anychart.enums.ScaleComparisonMode mode) {
     ...
     * Setter for the scale changes mode.
     */
    public uk.easys.calculations.anychart.scales.Logarithmic comparisonMode(String mode) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Logarithmic maxTicksCount(Number count) {
