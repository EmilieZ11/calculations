...
import uk.easys.calculations.anychart.scales.StockScatterDateTime;
...
public class StockOrdinalDateTime extends StockScatterDateTime {
     ...
     */
    public uk.easys.calculations.anychart.scales.StockOrdinalDateTime ticksCount(Number count) {
