...
public class ScatterBase extends Base {
     ...
     */
    public uk.easys.calculations.anychart.scales.ScatterBase alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public uk.easys.calculations.anychart.scales.ScatterBase alignMinimum(Boolean enabled) {
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public uk.easys.calculations.anychart.scales.ScatterBase extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public uk.easys.calculations.anychart.scales.ScatterBase inverted(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.ScatterBase maxTicksCount(Number count) {
     ...
     */
    public uk.easys.calculations.anychart.scales.ScatterBase maximum(Number maximum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.ScatterBase minimum(Number minimum) {
...
call of this method if needed.
     */
    public uk.easys.calculations.anychart.scales.ScatterBase startAutoCalc() {
