...
public class DistinctColors extends Base {
     ...
     */
    public uk.easys.calculations.anychart.palettes.DistinctColors itemAt(Number index, uk.easys.calculations.anychart.graphics.vector.Fill color) {
     ...
     */
    public uk.easys.calculations.anychart.palettes.DistinctColors items(uk.easys.calculations.anychart.graphics.vector.Fill[] color, uk.easys.calculations.anychart.graphics.vector.Fill var_args) {
