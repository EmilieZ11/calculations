...
Passed value is rounded and defaults to 1 in case of incorrect settings.
     */
    public uk.easys.calculations.anychart.scales.OrdinalTicks interval(Number interval) {
     ...
     */
    public uk.easys.calculations.anychart.scales.OrdinalTicks maxCount(Number count) {
     ...
     */
    public uk.easys.calculations.anychart.scales.OrdinalTicks names(String[] names) {
     ...
     */
    public uk.easys.calculations.anychart.scales.OrdinalTicks set(String[] ticks) {
