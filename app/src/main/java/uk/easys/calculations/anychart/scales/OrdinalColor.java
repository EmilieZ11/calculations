...
public class OrdinalColor extends Base {
     ...
     */
    public uk.easys.calculations.anychart.scales.OrdinalColor colors(String[] colors) {
     ...
     */
    public uk.easys.calculations.anychart.scales.OrdinalColor inverted(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.OrdinalColor names(String[] names) {
     ...
     */
    public uk.easys.calculations.anychart.scales.OrdinalColor ranges(String[] ranges) {
...
call of this method if needed.
     */
    public uk.easys.calculations.anychart.scales.OrdinalColor startAutoCalc() {
     ...
     */
    public uk.easys.calculations.anychart.scales.OrdinalColor ticks(String ticks) {
