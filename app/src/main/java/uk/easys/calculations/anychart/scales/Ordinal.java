...
import uk.easys.calculations.anychart.scales.Base;
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public uk.easys.calculations.anychart.scales.Ordinal extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public uk.easys.calculations.anychart.scales.Ordinal inverted(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Ordinal names(String[] names) {
...
call of this method if needed.
     */
    public uk.easys.calculations.anychart.scales.Ordinal startAutoCalc() {
     ...
     */
    public uk.easys.calculations.anychart.scales.OrdinalTicks ticks() {
        return new uk.easys.calculations.anychart.scales.OrdinalTicks(jsBase + ".ticks()");
    }
    /**
     * Setter for set of scale ticks in terms of data values.
     */
    public uk.easys.calculations.anychart.scales.Ordinal ticks(String ticks) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     * 
     */
    public uk.easys.calculations.anychart.scales.Ordinal values(String[] values) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Ordinal weights(Number[] weights) {
