...
public class Geo extends Base {
     ...
     */
    public uk.easys.calculations.anychart.scales.Geo extendDataRange(Number x, Number y, String var_args) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Geo gap(Number gap) {
...
If the number of ticks is greater than set in maxTicksCount(), the scale calculates from 4 to 6 ticks.
     */
    public uk.easys.calculations.anychart.scales.Geo maxTicksCount(Number count) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Geo maximumX(Number maximumX) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Geo maximumY(Number maximumY) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Geo minimumX(Number minimumX) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Geo minimumY(Number minimumY) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Geo precision(Number[] precision) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Geo precision(Number xPrecision, Number yPrecision) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GeoTicks xMinorTicks() {
        return new uk.easys.calculations.anychart.scales.GeoTicks(jsBase + ".xMinorTicks()");
    }
    /**
     * Setter for the set of scale x minor ticks.
     */
    public uk.easys.calculations.anychart.scales.Geo xMinorTicks(String settings) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GeoTicks xTicks() {
        return new uk.easys.calculations.anychart.scales.GeoTicks(jsBase + ".xTicks()");
    }
    /**
     * Setter for the set of scale x ticks.
     */
    public uk.easys.calculations.anychart.scales.Geo xTicks(String settings) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GeoTicks yMinorTicks() {
        return new uk.easys.calculations.anychart.scales.GeoTicks(jsBase + ".yMinorTicks()");
    }
    /**
     * Setter for the set of scale y minor ticks.
     */
    public uk.easys.calculations.anychart.scales.Geo yMinorTicks(String settings) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GeoTicks yTicks() {
        return new uk.easys.calculations.anychart.scales.GeoTicks(jsBase + ".yTicks()");
    }
    /**
     * Setter for the set of scale y ticks.
     */
    public uk.easys.calculations.anychart.scales.Geo yTicks(String settings) {
