...
<b>Note:</b> Defines how many steps we need in gradient.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors count(Number count) {
     ...
     */
    public uk.easys.calculations.anychart.palettes.RangeColors itemAt(Number index, uk.easys.calculations.anychart.graphics.vector.SolidFill color) {
     ...
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(String[] color, uk.easys.calculations.anychart.graphics.vector.SolidFill var_args) {
     ...
     * Setter for color palette colors list.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(String[] color, String var_args) {
     ...
     * Setter for color palette colors list.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(uk.easys.calculations.anychart.graphics.vector.LinearGradientFill color, uk.easys.calculations.anychart.graphics.vector.SolidFill var_args) {
     ...
     * Setter for color palette colors list.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(uk.easys.calculations.anychart.graphics.vector.LinearGradientFill color, String var_args) {
     ...
     * Setter for color palette colors list.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(uk.easys.calculations.anychart.graphics.vector.RadialGradientFill color, uk.easys.calculations.anychart.graphics.vector.SolidFill var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".items(%s, %s);", (color != null) ? color.getJsBase() : null, (var_args != null) ? var_args.getJsBase() : null));
     ...
     * Setter for color palette colors list.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(uk.easys.calculations.anychart.graphics.vector.RadialGradientFill color, String var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".items(%s, %s);", (color != null) ? color.getJsBase() : null, wrapQuotes(var_args)));
     ...
     * Setter for color palette colors list.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(uk.easys.calculations.anychart.graphics.vector.GradientKey[] color, uk.easys.calculations.anychart.graphics.vector.SolidFill var_args) {
     ...
     * Setter for color palette colors list.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(uk.easys.calculations.anychart.graphics.vector.GradientKey[] color, String var_args) {
     ...
     * Setter for color palette colors list.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(uk.easys.calculations.anychart.graphics.vector.SolidFill color, uk.easys.calculations.anychart.graphics.vector.SolidFill var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".items(%s, %s);", (color != null) ? color.getJsBase() : null, (var_args != null) ? var_args.getJsBase() : null));
     ...
     * Setter for color palette colors list.
     */
    public uk.easys.calculations.anychart.palettes.RangeColors items(uk.easys.calculations.anychart.graphics.vector.SolidFill color, String var_args) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".items(%s, %s);", (color != null) ? color.getJsBase() : null, wrapQuotes(var_args)));
