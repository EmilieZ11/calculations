package uk.easys.calculations.anychart.editor;
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public uk.easys.calculations.anychart.editor.Editor dialogVisible(Boolean enabled) {
...
(example for the versioned file: https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public void getJavascript(uk.easys.calculations.anychart.editor.JavascriptOptions outputOptions) {
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public uk.easys.calculations.anychart.editor.Editor localization(String settings) {
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public uk.easys.calculations.anychart.editor.Step step(uk.easys.calculations.anychart.enums.EditorSteps stepName) {
        return new uk.easys.calculations.anychart.editor.Step(String.format(Locale.US, jsBase + ".step(%s)", (stepName != null) ? stepName.getJsBase() : null));
    }
    /**
     * Getter for the step by its name.<br/>
<br>
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public uk.easys.calculations.anychart.editor.Step step(String stepName) {
        return new uk.easys.calculations.anychart.editor.Step(String.format(Locale.US, jsBase + ".step(%s)", wrapQuotes(stepName)));
    }
    /**
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public uk.easys.calculations.anychart.editor.Step step(uk.easys.calculations.anychart.enums.EditorSteps stepName, Boolean value) {
        return new uk.easys.calculations.anychart.editor.Step(String.format(Locale.US, jsBase + ".step(%s, %s)", (stepName != null) ? stepName.getJsBase() : null, value));
    }
    /**
     * Setter for the step settings.<br/>
Call this method only before {api:anychart.editor.Editor#render}render{api} chart editor.<br/>
...
https://cdn.anychart.com/releases/8.4.0/js/anychart-editor.min.js)</i>
     */
    public uk.easys.calculations.anychart.editor.Step step(String stepName, Boolean value) {
        return new uk.easys.calculations.anychart.editor.Step(String.format(Locale.US, jsBase + ".step(%s, %s)", wrapQuotes(stepName), value));
    }
