...
<b>Note</b>: When {@link anychart.scales.ScatterTicks#mode} set to 'logarithmic', the allowFractional flag is always <b>false</b>.
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks allowFractional(Boolean enabled) {
...
<b>Note:</b> it is a number that is guaranteed to set a tick if the number is located between minimum and maximum values of the scale.
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks base(Number baseValue) {
...
<b>Note:</b> Final number of ticks can be greater (one more tick can be added).
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks count(Number count) {
...
<b>Note:</b> Final number of ticks can be greater than maximum (one more tick can be added).
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks count(Number minimumCount, Number maximumCount) {
...
<b>Note:</b> You can get interval value only if it was set explicitly, otherwise its returns NaN.
     ...
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks interval(Number value) {
...
<b>Note:</b> Use only with logarithmic scales.
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks mode(uk.easys.calculations.anychart.enums.ScatterTicksMode mode) {
...
<b>Note:</b> Use only with logarithmic scales.
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks mode(String mode) {
     ...
     */
    public uk.easys.calculations.anychart.scales.ScatterTicks set(String[] ticks) {
