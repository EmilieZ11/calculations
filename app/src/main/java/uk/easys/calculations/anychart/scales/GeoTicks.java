...
<b>Note:</b> Final number of ticks can be greater (one more tick can be added).
     */
    public uk.easys.calculations.anychart.scales.GeoTicks count(Number count) {
...
<b>Note:</b> Final number of ticks can be greater than maximum (one more tick can be added).
     */
    public uk.easys.calculations.anychart.scales.GeoTicks count(Number minimumCount, Number maximumCount) {
...
<b>Note:</b> You can get interval value only if it was set explicitly, it returns NaN otherwise
     ...
     */
    public uk.easys.calculations.anychart.scales.GeoTicks interval(Number interval) {
     ...
     */
    public uk.easys.calculations.anychart.scales.GeoTicks set(String[] ticks) {
