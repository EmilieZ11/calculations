...
import uk.easys.calculations.anychart.scales.ScatterBase;
...
public class DateTimeWithCalendar extends ScatterBase {
     ...
     * 
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar calendar(uk.easys.calculations.anychart.scales.Calendar calendar) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar count(Number count) {
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar extendDataRange(String var_args) {
...
with a passed interval. Ticks fill space from the fromPix pixel to the toPix pixel (if available).
     */
    public void getTicks(Number fromPix, Number toPix, uk.easys.calculations.anychart.enums.Interval unit, Number count) {
...
instead of bottom-to-top and left-to-right.
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar inverted(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar maximum(Number maximum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTime maximumGap(Number gap) {
        return new uk.easys.calculations.anychart.scales.DateTime(String.format(Locale.US, jsBase + ".maximumGap(%s)", gap));
    }
    /**
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar minimum(Number minimum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTime minimumGap(Number gap) {
        return new uk.easys.calculations.anychart.scales.DateTime(String.format(Locale.US, jsBase + ".minimumGap(%s)", gap));
    }
    /**
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar skipHolidays(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTime softMaximum(Number maximum) {
        return new uk.easys.calculations.anychart.scales.DateTime(String.format(Locale.US, jsBase + ".softMaximum(%s)", maximum));
    }
    /**
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTime softMinimum(Number minimum) {
        return new uk.easys.calculations.anychart.scales.DateTime(String.format(Locale.US, jsBase + ".softMinimum(%s)", minimum));
    }
    /**
     * Informs scale that an auto-range calculation started for the chart, so it should reset its data range on the first
call of this method if needed.
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar startAutoCalc() {
     ...
     * 
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar startDate(Number date) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar unit(uk.easys.calculations.anychart.enums.Interval interval) {
     ...
     * Setter for the unit interval.
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar unit(String interval) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar unitPixSize(Number size) {
     ...
     * Setter for the unit size.
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar unitPixSize(String size) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar alignMinimum(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.DateTimeWithCalendar maxTicksCount(Number count) {
