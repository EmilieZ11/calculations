...
public class Linear extends ScatterBase {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear alignMaximum(Boolean enabled) {
     ...
     * Setter for a flag if the minimum should be aligned by major ticks interval.
     */
    public uk.easys.calculations.anychart.scales.Linear alignMinimum(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear compareWith(uk.easys.calculations.anychart.enums.ScaleCompareWithMode mode) {
     ...
     * Setter for the date which should be used as a changes zero for series.
     */
    public uk.easys.calculations.anychart.scales.Linear compareWith(String mode) {
     ...
     * Setter for the date which should be used as a changes zero for series.
     */
    public uk.easys.calculations.anychart.scales.Linear compareWith(Number mode) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear comparisonMode(uk.easys.calculations.anychart.enums.ScaleComparisonMode mode) {
     ...
     * Setter for the scale changes mode.
     */
    public uk.easys.calculations.anychart.scales.Linear comparisonMode(String mode) {
...
<b>Note:</b> Attention! {@link anychart.scales.Base#finishAutoCalc} drops all passed values.
     */
    public uk.easys.calculations.anychart.scales.Linear extendDataRange(String var_args) {
...
instead of bottom-to-top and left-to-right.
     */
    public uk.easys.calculations.anychart.scales.Linear inverted(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear maximum(Number maximum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear maximumGap(Number gap) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear minimum(Number minimum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear minimumGap(Number gap) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear minorTicks(String settings) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear softMaximum(Number maximum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear softMinimum(Number minimum) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear stackDirection(uk.easys.calculations.anychart.enums.ScaleStackDirection direction) {
     ...
     * Setter for the stacking direction.
     */
    public uk.easys.calculations.anychart.scales.Linear stackDirection(String direction) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear stackMode(uk.easys.calculations.anychart.enums.ScaleStackMode value) {
     ...
     * Setter for the stacked mode.
     */
    public uk.easys.calculations.anychart.scales.Linear stackMode(String value) {
...
call of this method if needed.
     */
    public uk.easys.calculations.anychart.scales.Linear startAutoCalc() {
...
Flag to stick to zero value on auto calc if gaps lead to zero crossing.
     */
    public uk.easys.calculations.anychart.scales.Linear stickToZero(Boolean enabled) {
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear ticks(String settings) {
...
<b>Note:</b> returns correct values only after {@link anychart.scales.Base#finishAutoCalc} or <b>chart.draw()</b>.
     ...
     */
    public uk.easys.calculations.anychart.scales.Linear maxTicksCount(Number count) {
