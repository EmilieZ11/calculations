...
Removes it from parent layer, nulls links, removes from DOM.
     ...
     */
    public void ranges(uk.easys.calculations.anychart.ui.rangeselector.Range[] ranges) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".ranges(%s);", arrayToString(ranges)));
    }
    /**
     * Renders the range selector.
     */
    public void render(uk.easys.calculations.anychart.charts.Stock parentElement) {
     ...
     */
    public void target(uk.easys.calculations.anychart.charts.Stock chart) {
     ...
     */
    public uk.easys.calculations.anychart.ui.RangeSelector zoomLabelText(String text) {
